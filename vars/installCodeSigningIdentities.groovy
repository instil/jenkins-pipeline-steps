def call(String appIdentifier, String type, String matchPasswordCredentialsId = "FASTLANE_MATCH_PASSWORD", String gitUrlCredentialsId = "FASTLANE_MATCH_GIT_URL", boolean generateAppleCerts=false) {
    withCredentials([
        ...
        sh "fastlane run match app_identifier:'${appIdentifier}' type:'${type}' keychain_name:'fastlane.keychain' keychain_password:'$KEYCHAIN_PASSWORD' git_url:'$GIT_URL' readonly:'true' verbose:'true' generate_apple_certs:'${generate_apple_certs}'"
    }
}
